 ...
 */
public class EduDetailResumeCustomerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EduDetailResumeCustomerAdapter(RecyclerView recyclerView, Context context, List<LstEducationHi> lstEducationHis, BaseFragment homeFragment) {

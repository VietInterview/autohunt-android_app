...
public class ExpDetailCVNTDAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExpDetailCVNTDAdapter(RecyclerView recyclerView, Context context, int total, DetailJobResponse detailJobResponse, ArrayList<CvList> cvLists, BaseFragment homeFragment) {

 ...
 */
public class SendInterviewRequest extends BaseJsonRequest<ViewEmailInterviewResponse, ErrorResponse> {
    private int cvId;
    private int id;
    ...
    public SendInterviewRequest(int cvId, int id, String interviewAddress, String interviewDate, int jobId, String note, String round, int status) {
        this.cvId = cvId;
        this.id = id;

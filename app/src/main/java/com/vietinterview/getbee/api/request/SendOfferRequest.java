...
public class SendOfferRequest extends BaseJsonRequest<SendOfferResponse, ErrorResponse> {
    ...
    public SendOfferRequest(int cvId, int id, int curency, String position, int jobId, String note, String round, int status, int salary, String workAddress, String workTime) {
        this.cvId = cvId;
        this.id = id;

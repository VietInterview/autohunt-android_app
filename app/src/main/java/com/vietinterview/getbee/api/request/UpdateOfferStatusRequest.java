 ...
 */
public class UpdateOfferStatusRequest extends BaseJsonRequest<SendOfferResponse, ErrorResponse> {
    private int cvId;
    private int id;
    private int curency;
    ...
    public UpdateOfferStatusRequest(int cvId, int id, int curency, String position, int jobId, String note, String round, int status, long salary, String workAddress, String workTime) {
        this.cvId = cvId;
        this.id = id;

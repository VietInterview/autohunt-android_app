...
public class UpdateOfferStatusRequest extends BaseJsonRequest<SendOfferResponse, ErrorResponse> {
    ...
    public UpdateOfferStatusRequest(int cvId, int id, int curency, String position, int jobId, String note, String round, int status, int salary, String workAddress, String workTime) {
        this.cvId = cvId;
        this.id = id;

 ...
 */
public class ViewEmailInterviewRequest extends BaseJsonRequest<ViewEmailInterviewResponse, ErrorResponse> {
    private int cvId;
    private int id;
    ...
    public ViewEmailInterviewRequest(int cvId, int id, String interviewAddress, String interviewDate, int jobId, String note, String round, int status) {
        this.cvId = cvId;
        this.id = id;

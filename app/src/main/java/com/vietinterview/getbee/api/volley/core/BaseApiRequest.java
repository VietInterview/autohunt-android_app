...
import com.vietinterview.getbee.api.volley.bean.ErrorMessage;
import com.vietinterview.getbee.api.volley.event.ApiEvent;
import com.vietinterview.getbee.api.volley.event.ApiEventType;
import com.vietinterview.getbee.constant.ApiConstant;
import com.vietinterview.getbee.constant.ApiParam;
...
public abstract class BaseApiRequest<T> implements BaseTypeRequest.GsonRequestHeaderOnResult {
    ...
    protected boolean checkNetwork() {
        return NetworkUtils.getInstance(GetBeeApplication.getInstance()).isNetworkConnected();
    }

...
public class ClearableRegularEditText extends NunitoEditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcherListener {
    ...
    public ClearableRegularEditText(Context context) {
        super(context);
        init();
    }

    public ClearableRegularEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ClearableRegularEditText(Context context, AttributeSet attrs, int defStyle) {

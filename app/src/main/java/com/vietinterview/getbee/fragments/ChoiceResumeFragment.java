...
import com.vietinterview.getbee.adapter.MyResumeChoiceAdapter;
 ...
 */
public class ChoiceResumeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, OnLoadMoreListener {
    ...
    private MyResumeChoiceAdapter myCVChoiceAdapter;
    ...
    public static ChoiceResumeFragment newInstance(DetailJobResponse detailJobResponse, CVResponse cvResponse) {
        ChoiceResumeFragment fm = new ChoiceResumeFragment();
...
//        searchMyCV(0, 0, mPage);
    ...
    protected void initData() {
        ...
        myCVChoiceAdapter = new MyResumeChoiceAdapter(recyclerView, getActivity(), mCvResponse.getTotal(), detailJobResponse, cvLists, ChoiceResumeFragment.this);
        myCVChoiceAdapter.setOnLoadMoreListener(ChoiceResumeFragment.this);
        ...
        searchMyCVRequest.callRequest(getActivity(), new ApiObjectCallBack<CVResponse, ErrorResponse>() {
            ...
            public void onSuccess(int status, CVResponse data, List<CVResponse> dataArrayList, String message) {
                ...
                if (isAdded()) {
                    ...
                    if (page == 0) {
                        myCVChoiceAdapter = new MyResumeChoiceAdapter(recyclerView, getActivity(), data.getTotal(), detailJobResponse, cvLists, ChoiceResumeFragment.this);
                        myCVChoiceAdapter.setOnLoadMoreListener(ChoiceResumeFragment.this);
                        recyclerView.setAdapter(myCVChoiceAdapter);
                    }

 ...
 */
public class ComDetailResumeCustomerFragment extends BaseFragment {
    ...
    public static ComDetailResumeCustomerFragment newInstance(DetailCVCustomerResponse detailCVCustomerResponse) {
        ComDetailResumeCustomerFragment fm = new ComDetailResumeCustomerFragment();

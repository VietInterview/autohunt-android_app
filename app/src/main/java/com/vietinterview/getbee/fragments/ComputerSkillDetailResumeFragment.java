 ...
 */
public class ComputerSkillDetailResumeFragment extends BaseFragment {
    ...
    public static ComputerSkillDetailResumeFragment newInstance(DetailCVResponse detailCVResponse) {
        ComputerSkillDetailResumeFragment fm = new ComputerSkillDetailResumeFragment();

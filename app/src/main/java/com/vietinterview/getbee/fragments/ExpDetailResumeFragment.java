 ...
 */
public class ExpDetailResumeFragment extends BaseFragment {
    ...
    public static ExpDetailResumeFragment newInstance(DetailCVResponse detailCVResponse) {
        ExpDetailResumeFragment fm = new ExpDetailResumeFragment();
    ...
    protected void initView(View root, LayoutInflater inflater, ViewGroup container) {
        ...
        for (int i = 0; i < detailCVResponse.getLstEmploymentHis().size(); i++) {
            ...
            listDataChild.put(listDataGroup.get(i).getCompanyName(), lstEmploymentHis);
        }

...
public class ExperienceFragment extends BaseFragment {
    ...
    private ExStepExListViewAdapter exStepExListViewAdapter;
    ...
    protected void initView(View root, LayoutInflater inflater, ViewGroup container) {
        ...
        exStepExListViewAdapter = new ExStepExListViewAdapter(getActivity(), listDataGroup, listDataChild);
        expandableListView.setAdapter(exStepExListViewAdapter);
        ...
        exStepExListViewAdapter.notifyDataSetChanged();
    }

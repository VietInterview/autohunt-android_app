 ...
 */
public class InfoDetailCVNTDFragment extends BaseFragment {
    ...
    public static InfoDetailCVNTDFragment newInstance(DetailCVCustomerResponse detailCVCustomerResponse) {
        InfoDetailCVNTDFragment fm = new InfoDetailCVNTDFragment();

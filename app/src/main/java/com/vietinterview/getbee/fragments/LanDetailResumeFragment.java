 ...
 */
public class LanDetailResumeFragment extends BaseFragment {
    ...
    public static LanDetailResumeFragment newInstance(DetailCVResponse detailCVResponse) {
        LanDetailResumeFragment fm = new LanDetailResumeFragment();
